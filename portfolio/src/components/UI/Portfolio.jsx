...
import data from "../../assests/data/portfolioData";
      ...
      <div className="container">
        <div className="flex items-center justify-between flex-wrap">
          ...
          <div className="flex gap-3">
            ...
            <button onClick={()=>setselectTab("Machine Learning")}
              className="text-smallTextColor border border-solid border-smallTextColor py-2 px-4
                rounded-[8px] "
            >
              Machine learning
        ...
        <div className="flex items-center gap-4 flex-wrap mt-12">
          {portfolios?.slice(0,nextItems)?.map((portfolio, index) => (
            ...
            className="text-white bg-Color hover:bg-smallTextColor py-2 px-4 rounded-[8px] font-[500] ease-in duration-200">
                    Load More
                    </button>
                    )}
            </div>
